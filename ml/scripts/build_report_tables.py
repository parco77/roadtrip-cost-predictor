...
These sections are therefore built from the JSON that scripts/evaluation.py writes, which is the
same JSON the API reports, so the PDF and the running service cannot disagree.
